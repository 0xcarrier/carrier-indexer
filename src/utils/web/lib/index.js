...
function unpercent(value) {
  return (0, strings_1.toUtf8Bytes)(
    value.replace(/%([0-9a-f][0-9a-f])/gi, function (all, code) {
...
function _fetchData(connection, body, processFunc) {
  ...
  //           timer = null;
  //           reject(
  //             logger.makeError("timeout", logger_1.Logger.errors.TIMEOUT, {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 20:
            return [
              2 /*return*/,
              logger.throwError("failed response", logger_1.Logger.errors.SERVER_ERROR, {
                requestBody: bodyify(options.body, flatHeaders["content-type"]),
                requestMethod: options.method,
                url: url,
              }),
